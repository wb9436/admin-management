package com.ivan.manage.configuration.aspect;

import com.ivan.manage.configuration.annotation.Log;
import com.ivan.manage.configuration.shiro.ShiroUtils;
import com.ivan.manage.configuration.util.HttpContextUtils;
import com.ivan.manage.configuration.util.JSONUtils;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.ivan.manage.configuration.annotation.Log)")
